...
<div id="fh5co-page">
        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div style="text-align:center;font-weight:bold;font-size: larger" class="panel-heading">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">未来7天我要参加的会议</a>
                </div>
            ...
            <div class="panel panel-default">
                <div style="text-align:center;font-weight:bold;font-size: larger" class="panel-heading">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">已取消的会议</a>
                </div>
                <div id="collapseTwo" class="panel-collapse collapse">
                    <div style="padding-bottom: 0;" class="panel-body">
                        <form id="formSearch_2" class="form-horizontal">
                            <table id="tableconcel"
                                   class="table table-striped"
                                   data-toggle="table"
                                   data-show-columns="true"
                                   data-search="true"
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <th data-visible="false" data-field="meetingId">id</th>
                                    <th data-visible="false" data-field="peopleNum">num</th>
                                    <th data-field="cancelNotes">取消原因</th>
                                    <th data-visible="false" data-field="data">notes</th>
                                    <th data-events="operateEvent" class="col-xs-2" data-field="operation"
                                        data-formatter="operateFormatter">操作
                                    </th>
    ...
    <script type="text/javascript">
        function operateFormatter(value, row, index) {
            return [
                '<button  type="button" class="details nooutline btn btn-default  btn-sm" data-toggle="modal" data-target="#myModal">查看详情</button>',
            ].join('');
        }
    </script>
    <style type="text/css">
